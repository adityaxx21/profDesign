...
use App\Http\Controllers\orders\Product;
use App\Http\Controllers\orders\Transaction;
...
Route::group(['middleware' => 'auth'], function () {
  ...
  // Order Page Route
  Route::get('/orders/transaction', [Transaction::class, 'index'])->name('transaction');
  Route::get('/orders/product', [Product::class, 'index'])->name('product');
...
Route::post('/logout', [LogoutBasic::class, 'destroy'])
  ->middleware('auth')
  ->name('logout');
